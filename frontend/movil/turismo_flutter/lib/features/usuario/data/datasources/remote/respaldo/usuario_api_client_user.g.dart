...
class _UsuarioApiClientUser implements UsuarioApiClientUser {
  _UsuarioApiClientUser(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<UsuarioUserResponse> getUsuarioCompletoById(int idUsuario) async {
    ...
    final _options = _setStreamType<UsuarioUserResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/usuario/usuarioCompleto/${idUsuario}',
