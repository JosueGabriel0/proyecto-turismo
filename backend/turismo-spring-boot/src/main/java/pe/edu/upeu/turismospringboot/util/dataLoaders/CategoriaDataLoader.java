    ...
    public void run(String... args) {
        if (categoriaRepository.count() == 0) {
            ...
            if (familias.size() >= 2) {
                ...
                System.out.println(">>> No hay suficientes familias en la base de datos para asignar categorías.");
            }
        }
    }
}